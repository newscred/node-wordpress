...
maps.post = createFieldMaps({
	...
	dateGMT: /* datetime */ "post_date_gmt",
	excerpt: /* string */ "post_excerpt",
	format: /* string */"post_format",
	id: /* string */ "post_id", /* readonly */
	link: /* string */ "link" /* readonly */,
	previewLink: /* string */ "preview_link" /* readonly - requires NC plugin */,
	permalink: /* string */ "permalink" /* readonly - requires NC plugin */,
	slug: /* string */ "slug" /* readonly - requires NC plugin */,
	...
	isYoastInstalled: /* bool */ "is_yoast_installed"
}, {}, {
...
maps.uploadFile = createFieldMaps({
	name: /* string */ "name",
	type: /* string */ "type",
	bits: /* string */ "bits",
...
maps.editImageMeta = createFieldMaps({
  excerpt: /* string */ "post_excerpt",
  altText: /* string */ "image_alt",
  content: /* string */ "post_content"
});
